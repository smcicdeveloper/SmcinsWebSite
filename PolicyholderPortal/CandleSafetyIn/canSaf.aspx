 <%@ Page Language="VB" AutoEventWireup="false" CodeFile="canSaf.aspx.vb" Inherits="canSaf" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        <style type="text/css">
            html {background-image:url(CSS/Images/large-candle.jpg); background-repeat:no-repeat; background-position:center;}
