...
Partial Class candlesafety
    ...
    'Protected Sub valMatch_ServerValidate(ByVal source As Object, ByVal args As ServerValidateEventArgs)
    '    If args.Value.Length < 5 Then
    '        args.IsValid = False
    '    Else
    '        args.IsValid = True
    ...
    Protected Sub frmAddress_DataBinding(sender As Object, e As System.EventArgs) Handles frmAddress.DataBinding
        'Dim StepNextButton As Button = CType(Wizard1.FindControl("StepNextButton"), Button)
        'If frmAddress.DataItemCount = 0 Then
