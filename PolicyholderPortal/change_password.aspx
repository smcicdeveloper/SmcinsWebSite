...
<%--               <asp:RequiredFieldValidator 
        ...
        <div class="password-change">
            ...
            <p>Click the logout link below to return back to the policyholder portal login.</p>
           <asp:LoginStatus ID="LoginStatus2" runat="server" LogoutAction="Redirect" LogoutPageUrl="~/login/login_p.aspx" />
