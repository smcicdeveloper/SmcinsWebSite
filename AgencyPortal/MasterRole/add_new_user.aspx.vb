...
Partial Class AgencyPortal_add_new_user
    ...
    Protected Sub GridView1_RowDataBound(sender As Object, e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            'Dim Role As String = CType(DataBinder.Eval(e.Row.DataItem, "Role"), String)
            ...
            'Dim lnkAction As LinkButton = CType(GridView1.FindControl("lnkAction"), LinkButton)
            'If Role = "Agent" Then
            ...
            '    'e.Row.BackColor = CType(colConvert.ConvertFromString("#E2E2E2"), System.Drawing.Color)
