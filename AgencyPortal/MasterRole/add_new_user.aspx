...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
        ...
        <div id="go_left">
          ...
          <asp:CreateUserWizard 
               ...
               Font-Bold="True" 
               Font-Size="Medium" 
               ContinueDestinationPageUrl="~/AgencyPortal/MasterRole/add_new_user.aspx">
                    <WizardSteps>
                        <asp:WizardStep runat="server" StepType="Start" Title="SelectAgency">
...
<%--                            <asp:RadioButtonList 
                        ...
                        <asp:WizardStep runat="server" StepType="Finish" Title="CreateProfile">
                        <table border="0" style="font-weight: bold; font: 70% tahoma, Arial, Helvetica, sans-serif;">
                        <tr>
                          <td align="center" class="createUser_title" colspan="2">
                ...
                <div id="go_right">
                   <asp:GridView 
                        ...
                        DataKeyNames="Id" PageSize="12" BorderStyle="None">
                    <Columns>
...
<asp:objectdatasource 
     ID="odsUserProfiles"
     runat="server" 
     InsertMethod="CreateAgentProfileFromMaster" 
...
<%--    <asp:SqlDataSource 
         ID="sdsHierarchy" 
         runat="server" 
         ConnectionString="Data Source=172.16.1.223;Database=testnetdb;user id=WEBUSR;password=smcw3bu$r;" 
         ProviderName="System.Data.SqlClient" 
         SelectCommand="SELECT MasterID, MasterID + ' - ' + AgencyName As AGENCY FROM AgencyOriginationTable WHERE (MasterKeyID = @UserNameIs)">
        <SelectParameters>
            <asp:SessionParameter Name="UserNameIs" SessionField="UserNameIs" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>--%>
        ...
        <asp:ObjectDataSource 
         ID="sdsHierarchy" 
         SelectMethod="GetMasterAgencies" 
         TypeName="smci.SqlAccessLayer.MySqlCode" 
         runat="server">
         <SelectParameters>
            <asp:SessionParameter Name="UserNameIs" SessionField="UserNameIs" Type="String" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="wizzard_footer">
        ...
        <asp:HyperLink ID="hlnkInstruction" runat="server" 
            NavigateUrl="~/AgencyPortal/pdf/Agency Instructions.pdf" CssClass="wizzard_footer_hyperlink" target="_blank">Instructions</asp:HyperLink>
    </div> 
</asp:Content>
