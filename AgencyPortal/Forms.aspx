<%@ Page Title="" Language="VB" MasterPageFile="~/smcins_agent.master" AutoEventWireup="false" CodeFile="Forms.aspx.vb" Inherits="AgencyPortal_Forms" %>
         ...
         <ItemTemplate>
          ...
          <hr />
             <asp:GridView 
                  ...
                  CellPadding="3" 
                  CellSpacing="1"
                  EmptyDataText="No Forms" ForeColor="#666666">
                 <Columns>
