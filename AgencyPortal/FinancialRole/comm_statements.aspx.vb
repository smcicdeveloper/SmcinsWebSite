...
Partial Class AgencyPortal_FinancialRole_comm_statements
    ...
    Sub GetDateRange()
        ...
        If ddlYear.SelectedValue = "119" Then
    ...
    Private Function GetData1(ByVal query As String) As DataTable
    ...
    Private Function GetData3(ByVal query As String) As DataTable
        Dim conString As String = ConfigurationManager.ConnectionStrings("iSeries").ConnectionString
        Dim cmd As New iDB2Command(query)
