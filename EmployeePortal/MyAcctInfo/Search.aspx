<%@ Page Title="" Language="VB" MasterPageFile="~/Shared/ElectronicFormView.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" CodeFile="Search.aspx.vb" Inherits="emptools_MyAcctInfo_Search" %>
        ...
        $(document).ready(function () {
            ...
            $("#accordion-2").accordion({
                ...
                change: function (event, ui) {
                    var index = $(this).children('h2').index(ui.newHeader);
...
<%--    &nbsp;|&nbsp;
       <asp:LinkButton 
        ID="lnkButtonDeleteAll" 
        CommandName="Delete"
        Text="Delete"
        CausesValidation="false"
        OnClientClick="return confirm('Are you sure?');"
        runat="server" onclick="lnkButtonDeleteAll_Click" />
         &nbsp;|&nbsp;--%>
          ...
          <table>
           ...
           <tr>
            ...
            <tr>
             ...
             <td>
                <asp:TextBox ID="txtChurchEmail" Text='<%# Eval("church_email") %>' runat="server" 
                  Width="285px" BorderStyle="Solid" BorderColor="White" ReadOnly="True" Enabled="False" />
             </td>
            </tr>
            <tr>
            <td>
                ...
                <div id="accordion-2">
                    ...
                    <div id="row1">
                        <asp:GridView 
                             ...
                             TypeName="_GetRecord" 
                             EmptyDataText="There are no contacts to display." CellSpacing="6" 
                            Font-Size="12px" onrowupdated="grvEditAllCalls_RowUpdated" 
                            onrowdatabound="grvEditAllCalls_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Full Name" SortExpression="full_name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditFullName" runat="server" Text='<%# Bind("full_name") %>' Width="124px" MaxLength="30" />
                                            <asp:RequiredFieldValidator ID="rfvEditFullName" ControlToValidate="txtEditFullName" runat="server" Text="*" ForeColor="Red" ErrorMessage="Full Name Required." />
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Phone Number" SortExpression="church_number">
                                        <ItemTemplate>
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:MaskedEditExtender 
                                                 ...
                                                 TargetControlID="txtEditChurchNumber" 
                                                 MaskType="Number" 
                                                 Mask="999-999-9999"
                                                 runat="server">
                                            </asp:MaskedEditExtender>
                                    ...
                                    <asp:TemplateField HeaderText="Cell Phone" SortExpression="cell_phone">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <asp:MaskedEditExtender 
                                                 ...
                                                 TargetControlID="txtEditCellPhone" 
                                                 MaskType="Number" 
                                                 Mask="999-999-9999"
                                                 runat="server">                                                  
                                            </asp:MaskedEditExtender>
...
<%--                                            <asp:RegularExpressionValidator ID="regEditEmail" runat="server" Text="*" 
                                                ErrorMessage="Format Error: name@domain.com" ControlToValidate="txtEditEmail" 
                                                ForeColor="Red" 
                                    ...
                                    <asp:TemplateField HeaderText=" " SortExpression="department_id" 
                                        Visible="True" ShowHeader="False">
                                        <EditItemTemplate>
                                          <asp:DropDownList ID="ddlEditDepartmentId" runat="server" AppendDataBoundItems="True" SelectedValue='<%# Bind("department_id") %>'>
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblDepartment" runat="server" Text='<%# Bind("department_id") %>' ></asp:Label>
                                        </ItemTemplate>

                                        <HeaderStyle HorizontalAlign="Left" Wrap="False" Width="5px" />
...
<%--                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" 
                                                Text='<%# Bind("last_update", "{0:d}") %>' Visible="false"></asp:TextBox>
                                        </EditItemTemplate>--%>
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("last_update", "{0:d}") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Modify" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkButtonEdit" runat="server" CausesValidation="False" CommandName="Edit" Text="Edit" OnClientClick="GetScollerPosition();" />
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:LinkButton ID="lnkButtonUpdate" runat="server" CausesValidation="True" CommandName="Update" OnClientClick="GetScollerPosition();" onload="lnkButtonUpdate_Load" Text="Update" />
                                            &nbsp;<asp:LinkButton ID="lnkButtonCancel" runat="server" CausesValidation="False" CommandName="Cancel" Text="Cancel" OnClientClick="GetScollerPosition();" />
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                    ...
                    <div id="row2">                   
                         <asp:GridView 
                             ...
                             TypeName="_GetRecord" 
                             EmptyDataText="There are no contacts for this department." CellSpacing="6" 
                             Font-Size="12px" onrowupdated="grvEditAccounting_RowUpdated" 
                             onrowdatabound="grvEditAccounting_RowDataBound">
                                <Columns>
                                    <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkButtonDelete" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure?');" />
                                    ...
                                    <asp:TemplateField HeaderText="Full Name" SortExpression="full_name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditFullName2" runat="server" Text='<%# Bind("full_name") %>' Width="124px" MaxLength="30" />
                                            <asp:RequiredFieldValidator ID="rfvEditFullName" ControlToValidate="txtEditFullName2" runat="server" ForeColor="Red" Text="*" ErrorMessage="Full Name Required." />
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Phone Number" SortExpression="church_number">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditChurchNumber" runat="server" Text='<%# Bind("church_number") %>' MaxLength="12" Width="90px"></asp:TextBox>
                                            <asp:MaskedEditExtender 
                                    ...
                                    <asp:TemplateField HeaderText="Cell Phone" SortExpression="cell_phone">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditCellPhone" runat="server" Text='<%# Bind("cell_phone") %>' MaxLength="12" Width="90px"></asp:TextBox>
                                            <asp:MaskedEditExtender 
                                    ...
                                    <asp:TemplateField HeaderText=" " SortExpression="department_id" 
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblDepartment" runat="server" 
                                                Text='<%# Bind("department_id") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" Wrap="False" Width="5px" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Notes" SortExpression="notes">
...
<%--                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" 
                                                Text='<%# Bind("last_update", "{0:d}") %>' ReadOnly="True"></asp:TextBox>
                                        </EditItemTemplate>--%>
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Bind("last_update", "{0:d}") %>'></asp:Label>
                                        </ItemTemplate>
                   ...
                   <h2><a href="#">+ Claims Contacts</a></h2>
                        <div id="row3">
                             <asp:GridView 
                                 ...
                                 TypeName="_GetRecord" 
                                 EmptyDataText="There are no contacts for this department." CellSpacing="6" 
                                 Font-Size="12px" onrowupdated="grvEditClaims_RowUpdated" 
                                 onrowdatabound="grvEditClaims_RowDataBound">
                                <Columns>
                               <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                    <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Full Name" SortExpression="full_name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditFullName3" runat="server" Text='<%# Bind("full_name") %>' MaxLength="30" Width="124px" />
                                            <asp:RequiredFieldValidator ID="rfvEditFullName" ControlToValidate="txtEditFullName3" runat="server" ForeColor="Red" Text="*" ErrorMessage="Full Name Required" />
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Phone Number" SortExpression="church_number">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditChurchNumber" runat="server" Text='<%# Bind("church_number") %>' MaxLength="30" Width="90px"></asp:TextBox>
                                            <asp:MaskedEditExtender 
                    ...
                    <h2><a href="#">+ Loss Control Contacts</a></h2>
                     <div id="row4">
                         <asp:GridView 
                             ...
                             CellSpacing="6" 
                             Font-Size="12px" 
                             onrowupdated="grvEditLossControl_RowUpdated" 
                             onrowdatabound="grvEditLossControl_RowDataBound">
                                <Columns>
                                     <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkButtonDelete" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure?');" />
                                    ...
                                    <asp:TemplateField HeaderText="Full Name" SortExpression="full_name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditFullName4" runat="server" Text='<%# Bind("full_name") %>' MaxLength="30" Width="124px" />
                                            <asp:RequiredFieldValidator ID="rfvEditFullName" ControlToValidate="txtEditFullName4" runat="server" ForeColor="Red" Text="*" ErrorMessage="Full Name Required" />
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                    </asp:TemplateField>
                   ...
                   <h2><a href="#">+ Marketing Contacts</a></h2>
                        <div id="row5">
                             <asp:GridView 
                                 ...
                                 TypeName="_GetRecord" 
                                 EmptyDataText="There are no contacts for this department." CellSpacing="6" 
                                 Font-Size="12px" onrowupdated="grvEditMarketing_RowUpdated" 
                                 onrowdatabound="grvEditMarketing_RowDataBound">
                                <Columns>
                                      <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkButtonDelete" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure?');" />
                                    ...
                                    <asp:TemplateField HeaderText="Full Name" SortExpression="full_name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditFullName5" runat="server" Text='<%# Bind("full_name") %>' MaxLength="30" Width="124px" />
                                            <asp:RequiredFieldValidator ID="rfvEditFullName" ControlToValidate="txtEditFullName5" runat="server" ForeColor="Red" Text="*" ErrorMessage="Full Name Required" />
                                        </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                    </asp:TemplateField>
                    ...
                    <h2><a href="#">+ Underwriting Contacts</a></h2>
                        <div id="row6">
                             <asp:GridView 
                                 ...
                                 TypeName="_GetRecord" 
                                 EmptyDataText="There are no contacts for this department." CellSpacing="6" 
                                 Font-Size="12px" onrowupdated="grvEditUnderwriting_RowUpdated" 
                                 onrowdatabound="grvEditUnderwriting_RowDataBound">
                                <Columns>
                              <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkButtonDelete" runat="server" CausesValidation="False" CommandName="Delete" Text="Delete" OnClientClick="return confirm('Are you sure?');" />
                                  ...
                                  <HeaderStyle HorizontalAlign="Left" Wrap="False" />
                                    ...
                                    <asp:TemplateField HeaderText="Full Name" SortExpression="full_name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtEditFullName6" runat="server" Text='<%# Bind("full_name") %>' MaxLength="30" Width="124px" />
                                            <asp:RequiredFieldValidator ID="rfvEditFullName" ControlToValidate="txtEditFullName6" runat="server" ForeColor="Red" Text="*" ErrorMessage="Full Name Required" />
                                         </EditItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                    </asp:TemplateField>
...
<%--                                        <EditItemTemplate>
        ...
        <EditItemTemplate>
            <asp:LinkButton 
                 ...
                 Text="Save"
                 runat="server" 
                 onload="lnkButtonSave_Load" 
                 onclick="lnkButtonSave_Click"  />
            &nbsp;|&nbsp;
            <asp:LinkButton 
                 ID="lnkCancel" 
                 CommandName="Cancel"
         ...
         <table>
           <tr>
            ...
            <td>
                ...
                <asp:ListItem Text="(None)" Value=""></asp:ListItem>
                <asp:ListItem Text="DJC" Value="DJC"></asp:ListItem>
                <asp:ListItem Text="ELB" Value="ELB"></asp:ListItem>
                <asp:ListItem Text="FTH" Value="FTH"></asp:ListItem>
                <asp:ListItem Text="JGJ" Value="JGJ"></asp:ListItem>
                ...
                <asp:ListItem Text="TFC" Value="TFC"></asp:ListItem>
                ...
                <asp:ListItem Text="WVM" Value="WVM"></asp:ListItem>
                </asp:DropDownList>
...
<%--                  <asp:RequiredFieldValidator ID="rfvCounty" ControlToValidate="txtCountyEdit" 
            ...
            <tr>
             ...
             <td>
                <asp:TextBox ID="txtChurchEmailEdit" Text='<%# Eval("church_email") %>' runat="server" 
                  Width="285px" MaxLenth="45" />
             </td>
            </tr>
            <tr>
            <td>
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  <asp:TextBox ID="txtPolicyDesc1Edit" runat="server" Text='<%# Bind("pol1_descr") %>' MaxLength="50" />
              ...
              <tr>
                ...
                <td><asp:TextBox ID="txtPolicyDesc2Edit" runat="server" 
                        Text='<%# Bind("pol2_descr") %>' MaxLength="50"  /></td>
             ...
             <tr>
                <td><asp:TextBox ID="txtEffDate3Edit" runat="server" CssClass="mydate" Text='<%# Bind("pol3_date") %>' 
                        width="80px" MaxLength="10" /></td>
                <td><asp:TextBox ID="txtPolicyDesc3Edit" runat="server" 
                        Text='<%# Bind("pol3_descr") %>' MaxLength="50"  /></td>
              ...
              <tr>
                <td><asp:TextBox ID="txtEffDate4Edit" runat="server" CssClass="mydate" Text='<%# Bind("pol4_date") %>' 
                        width="80px" MaxLength="10" /></td>
                <td><asp:TextBox ID="txtPolicyDesc4Edit" runat="server" 
                        Text='<%# Bind("pol4_descr") %>' MaxLength="0"  /></td>
              ...
              <tr>
                <td><asp:TextBox ID="txtEffDate5Edit" runat="server" CssClass="mydate" Text='<%# Bind("pol5_date") %>' 
                        width="80px" MaxLength="10" /></td>
                <td><asp:TextBox ID="txtPolicyDesc5Edit" runat="server" 
                        Text='<%# Bind("pol5_descr") %>' MaxLength="50"  /></td>
    ...
    <asp:HiddenField ID="HiddenField1" runat="server" />
        ...
        <asp:Panel 
            ...
            <div style="position:absolute;Top:2px;left:96%;font-size:14px;">
                <asp:LinkButton ID="lnkOk" Text="X" CausesValidation="false" runat="server" OnClick="OK_Click" />
            </div>
            <br />
            <br />
            <div>
           <asp:DetailsView 
                 ...
                 OnItemInserted="dlvAddContact_ItemInserted" 
                 CellPadding="4" 
                 CellSpacing="2">                
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="Full Name:" SortExpression="full_name">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtEditFulName" runat="server" Text='<%# Bind("full_name") %>'></asp:TextBox>
                        </EditItemTemplate>
                        <InsertItemTemplate>
                            <asp:TextBox ID="txtAddFullName" runat="server" MaxLength="30" Text='<%# Bind("fullname") %>' Width="190px" Wrap="False"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvAddFullName" runat="server" Text="*" ErrorMessage="Full name required!!!" ControlToValidate="txtAddFullName" ForeColor="Red" />
                        </InsertItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Phone Number:" SortExpression="church_number">
                        <ItemTemplate>
                        ...
                        <InsertItemTemplate>
                            ...
                            <asp:MaskedEditExtender 
                             ...
                             runat="server" 
                             TargetControlID="txtAddChurchNum" 
                             MaskType="Number" 
                             Mask="999-999-9999">
                            </asp:MaskedEditExtender>
                        </InsertItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Cell Phone:" SortExpression="cell_phone">
                        ...
                        <InsertItemTemplate>
                            ...
                            <asp:MaskedEditExtender 
                             ID="MaskedEditExtender3" 
                             TargetControlID="txtAddCellPhone" 
                             MaskType="Number"
                             Mask="999-999-9999"
                             runat="server">
                            </asp:MaskedEditExtender>
                    ...
                    <asp:TemplateField HeaderText="Notes:" SortExpression="notes">
                        ...
                        <InsertItemTemplate>
                            <asp:TextBox ID="txtAddNotes" runat="server" MaxLength="35" Text='<%# Bind("notes") %>' TextMode="MultiLine" Width="175px"></asp:TextBox>
                        </InsertItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkButtonNew" runat="server" CausesValidation="False" CommandName="New" Text="New" />
                        </ItemTemplate>
                        <InsertItemTemplate>
                            <asp:LinkButton ID="lnkButtonInsert" runat="server" CausesValidation="True" 
                                CommandName="Insert" Text="Insert" />
                            &nbsp;
                            <asp:LinkButton ID="lnkCancelContact" runat="server" CausesValidation="False" CommandName="Cancel" onclick="lnkCancelContact_Click" Text="Cancel" />
                        </InsertItemTemplate>
                    </asp:TemplateField>
                </Fields>
            </asp:DetailsView>
    ...
    <asp:ObjectDataSource 
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="ChurchEmail" />
    ...
    <asp:ObjectDataSource 
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="church_number" />
            <asp:Parameter Name="cell_phone" />
            <asp:Parameter Name="email" />
            <asp:Parameter Name="department_id" />
            <asp:Parameter Name="notes" />
            <asp:Parameter DefaultValue="" Name="last_update" />
        </UpdateParameters>
    </asp:ObjectDataSource>
    ...
    <asp:ObjectDataSource 
         ID="srcDeleteAllContacts" 
         TypeName="_GetRecord"
         SelectMethod="GetContactForAllCalls"
         DeleteMethod="DeleteAllContacts"
         runat="server">
        <DeleteParameters>
            <asp:ControlParameter ControlID="ace1Value" Name="cust_no" PropertyName="Value" 
                Type="String" />
