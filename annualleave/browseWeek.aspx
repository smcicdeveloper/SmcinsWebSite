		...
		<div class="scrollmid">
			...
			<form id="ALMain" runat="server">
				...
				<div id="mainBox">
					...
					<asp:TextBox width="90px" style="width:90px;" id="status1" class="mainTextBox" runat="server" BackColor="#FFFFFF" ReadOnly="True"></asp:TextBox>
					<BR>
					...
					<asp:TextBox width="90px" style="width:90px;" id="status2" class="mainTextBox" runat="server" BackColor="#FFFFFF" ReadOnly="True"></asp:TextBox>
					<BR>
					...
					<asp:TextBox width="90px" style="width:90px;" id="status3" class="mainTextBox" runat="server" BackColor="#FFFFFF" ReadOnly="True"></asp:TextBox>
					<BR>
					...
					<asp:TextBox width="90px" style="width:90px;" id="status4" class="mainTextBox" runat="server" BackColor="#FFFFFF" ReadOnly="True"></asp:TextBox>
					<BR>
					...
					<asp:TextBox width="90px" style="width:90px;" id="status5" class="mainTextBox" runat="server" BackColor="#FFFFFF" ReadOnly="True"></asp:TextBox>					
				</div>
				<div id="mainButtons">
			...
			<div id="pageBar">
					<asp:Button id="first" onclick="First_Click" runat="server" style="width:60px;height:25px;" Width="60px" height="25px" Text="<< First"></asp:Button>
					&nbsp;<asp:Button id="prev" onclick="Prev_Click" runat="server" style="width:60px;height:25px;" Width="60px" height="25px" Text="< Prev"></asp:Button>
					&nbsp;<asp:TextBox id="pages" runat="server" style="width:170px;" width="170px" class="mainTextBox" runat="server" BackColor="#FFFFFF" ReadOnly="True"></asp:TextBox>
					<asp:TextBox id="hiddenDay" runat="server" Visible="False"></asp:TextBox>
					&nbsp;<asp:Button id="next" onclick="Next_Click" runat="server" style="width:60px;height:25px;" Width="60px" height="25px" Text="Next >"></asp:Button>&nbsp;
					<asp:Button id="last" onclick="Last_Click" runat="server" style="width:60px;height:25px;" Width="60px" height="25px" Text="Last >>"></asp:Button>
					<BR>			
			</div>
			<BR>
			<div id="bottomText">
